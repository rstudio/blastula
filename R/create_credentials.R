...
#'
#' @param id An option to specify an identifying label for the filename. If no
#'   `id` is provided, an autogenerated filename will be constructed in the
#'   following way: `blastula-v1-<host_name>`.
...
#' # Gmail with `smtp_send()`; provide the
#' # `id` of "gmail_creds"
...
#' \pkg{keyring} package. With this key added, the credentials helper
#' [creds_key()] can be used in the `credentials` argument of [smtp_send()].
#'
#' @param id An option to specify an identifying label for the keyname. If no
#'   `id` is provided, an autogenerated keyname will be constructed in the
#'   following way: `blastula-v1-<host_name>`.
